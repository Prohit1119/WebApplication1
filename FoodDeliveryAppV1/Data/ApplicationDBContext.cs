using FoodDeliveryAppV1.Models;
using Microsoft.EntityFrameworkCore;
using System;
using System.Security.Cryptography.X509Certificates;

namespace FoodDeliveryAppV1.Data
{
    public class ApplicationDBContext:DbContext
    {
        public ApplicationDBContext(DbContextOptions<ApplicationDBContext> dbcontex):base(dbcontex)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasData(
                new Customer { Id = 1, CustomerName = "John Doe", Email = "john@example.com", password = "john@123", PhoneNumber = "9876543210", Address = "123 Main Street" },
                new Customer { Id = 2, CustomerName = "Jane Smith", Email = "jane@example.com", password = "jane@123", PhoneNumber = "5554443322", Address = "456 South Avenue" }
                );
